...
For Struct elements, `A` must be a positive power of two and a multiple of the element's natural
alignment. It aligns the array base; element stride remains `dsl_size_of(E)`.
