...
| `kernels/layernorm_kernel.py` | LayerNorm builder (`@flyc.kernel` API) |
| `kernels/rmsnorm_kernel.py` | RMSNorm builder (`@flyc.kernel` API) |
| `kernels/softmax_kernel.py` | Softmax builder (`@flyc.kernel` API) |
