...
LLVM_SRC_DIR="$BASE_DIR/llvm-project-internal"
LLVM_BUILD_DIR="$LLVM_SRC_DIR/build-flydsl-${LLVM_SHORT}"
LLVM_INSTALL_DIR="${LLVM_INSTALL_DIR:-$LLVM_SRC_DIR/mlir_install-${LLVM_SHORT}}"
LLVM_INSTALL_TGZ="${LLVM_INSTALL_TGZ:-$LLVM_SRC_DIR/mlir_install-${LLVM_SHORT}.tgz}"
