...
def test_batched_result_ownership(batches, layout):
    checks.check_batched_result_ownership(batches, layout)
...
def test_batched_scalar_and_warp_broadcast(universal):
    checks.check_batched_scalar_and_warp_broadcast(universal)
...
def test_batched_wspro_synchronization_scope(sync_physical_warp, layout):
    checks.check_batched_wspro_synchronization_scope(sync_physical_warp, layout)
...
def test_batched_reduce(width, universal):
    checks.check_batched_reduce(width, universal)
...
def test_matrix_batched_reduction_dtypes_and_operations(entry, width, op):
    checks.check_batched_reduction_dtypes_and_operations(entry, width, op)
