...
# =============================================================================
# NEW: @flyc.kernel API test — same correctness harness, uses ported kernel.
# =============================================================================
...
def test_mfma_a8_flyc_preshuffle(
    ...
    *,
    ...
    # compile_preshuffle_gemm_a8_flyc returns a JitFunction (auto-compiles on first call).
    ...
    # In the flyc API, M/N/K are baked into the kernel (no runtime params).
    # Tensors are passed as flat 1-D views.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Use the @flyc.kernel ported implementation.",
    )
