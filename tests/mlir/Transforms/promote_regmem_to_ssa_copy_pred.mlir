...
// CHECK-SAME: : (!fly.copy_atom<!fly_rocdl.cdna3.buffer_copy<64>, 16>, !fly.memref<f16, buffer_desc, 4:1>) -> vector<4xf16>
...
gpu.module @promote_rmem_to_vector_ssa_copy {
  gpu.func @promote_copy_atoms_to_ssa(%src: !fly.ptr<f16, global>, %dst: !fly.ptr<f16, global>) kernel {
    ...
    %src_desc = fly.make_ptr(%src, %c0_i16, %c4294967295_i64, %c1024_i32) : (!fly.ptr<f16, global>, i16, i64, i32) -> !fly.ptr<f16, buffer_desc>
    %src_view = fly.make_view(%src_desc, %vec4) : (!fly.ptr<f16, buffer_desc>, !fly.layout<4:1>) -> !fly.memref<f16, buffer_desc, 4:1>
    ...
    fly.copy_atom_call(%copy_in_soff, %src_view, %reg_view) : (!fly.copy_atom<!fly_rocdl.cdna3.buffer_copy<64>, 16>, !fly.memref<f16, buffer_desc, 4:1>, !fly.memref<f16, register, 4:1>) -> ()
...
// CHECK:   %[[ELEM:.*]] = vector.extract %[[SLICE]][%{{.*}}] : f16 from vector<4xf16>
  gpu.func @promote_loop_local_copy_to_ssa(%src: !fly.ptr<f16, global>, %dst: !fly.ptr<f16, global>) kernel {
    ...
    scf.for %iv = %c0 to %c2 step %c1 {
      ...
      fly.copy_atom_call(%copy_iter, %src_view, %reg_view) : (!fly.copy_atom<!fly_rocdl.cdna3.buffer_copy<64>, 16>, !fly.memref<f16, buffer_desc, 4:1>, !fly.memref<f16, register, 4:1>) -> ()
...
// CHECK-SAME: : (!fly.copy_atom<!fly_rocdl.cdna3.buffer_copy<64>, 16>, !fly.memref<f16, buffer_desc, 4:1>, vector<4xf16>, i1) -> vector<4xf16>
...
gpu.module @promote_rmem_to_vector_ssa_copy_pred {
  gpu.func @promote_pred_copy_to_ssa(%src: !fly.ptr<f16, global>, %dst: !fly.ptr<f16, global>, %pred_val: i1) kernel {
    ...
    fly.copy_atom_call(%copy_in_soff, %src_view, %reg_view, %pred_view) : (!fly.copy_atom<!fly_rocdl.cdna3.buffer_copy<64>, 16>, !fly.memref<f16, buffer_desc, 4:1>, !fly.memref<f16, register, 4:1>, !fly.memref<i1, register, 1:1>) -> ()
