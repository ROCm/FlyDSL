...
class _LocalOps(rocir.MlirModule):
    @rocir.jit
    ...
    @rocir.jit
    def local_partition_2d(self: rocir.T.i64):
        c1024 = 1024
        c32 = 32
        c5 = 5
        c1 = 1
    ...
    @rocir.jit
    def local_tile_2d(self: rocir.T.i64):
        c512 = 512
        c16 = 16
        c8 = 8
        c3 = 3
...
def test_local_partition():
    ...
    m = _LocalOps()
    assert "rocir.local_partition" in str(m.module)
...
def test_local_tile():
    ...
    m = _LocalOps()
    assert "rocir.local_tile" in str(m.module)
