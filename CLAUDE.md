...
| AOT export to C objects | [`docs/aot_export_guide.md`](docs/aot_export_guide.md) | `flyc.compile(...).export_to_c(...)`: PIC object + C ABI metadata, module lifecycle, status codes, `aot_config` link flags (`python/flydsl/compiler/aot.py`) |
