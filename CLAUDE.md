...
| In-kernel event tracing | [`docs/iket_guide.md`](docs/iket_guide.md) | `fx.iket` phase annotations on gfx942/gfx950, `FLYDSL_IKET_*` settings, Perfetto output; complements ATT |
