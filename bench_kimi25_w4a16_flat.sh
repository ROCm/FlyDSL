...
for flat in [False, True]:
    tag = 'flat' if flat else 'preshuffle'
    print(f'  S1 {tag} tk=128:', end=' '); run_moe_stage1(**ckw, tile_m=16, tile_n=64, tile_k=128, use_flat_layout=flat)
    print(f'  S1 {tag} tk=256:', end=' '); run_moe_stage1(**ckw, tile_m=16, tile_n=64, tile_k=256, use_flat_layout=flat)
    print(f'  S2 {tag} tk=128:', end=' '); run_moe_stage2(**ckw, tile_m=16, tile_n=128, tile_k=128, a2_fp8_in=a2c, a2_scale_in=None, use_flat_layout=flat)
    print(f'  S2 {tag} tk=256:', end=' '); run_moe_stage2(**ckw, tile_m=16, tile_n=128, tile_k=256, a2_fp8_in=a2c, a2_scale_in=None, use_flat_layout=flat)
...
print('--- preshuffle ---')
run_moe_stage1(**kw, tile_m=16, tile_n=64, tile_k=256, use_flat_layout=False)
print('--- flat/CK-tile ---')
run_moe_stage1(**kw, tile_m=16, tile_n=64, tile_k=256, use_flat_layout=True)

a2 = torch.randn(333, 8, 256, device='cuda', dtype=torch.bfloat16) * 0.1

print('====== Stage2 (tile 16x128x256) ======')
print('--- preshuffle ---')
run_moe_stage2(**kw, tile_m=16, tile_n=128, tile_k=256, a2_fp8_in=a2, a2_scale_in=None, use_flat_layout=False)
print('--- flat/CK-tile ---')
run_moe_stage2(**kw, tile_m=16, tile_n=128, tile_k=256, a2_fp8_in=a2, a2_scale_in=None, use_flat_layout=True)
"
