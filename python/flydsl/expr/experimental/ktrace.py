...
def require_matching_capacity(artifact) -> None:
    ...
    """
    # Set only by _capture_ktrace_names, which returns early when untraced, so a
    # non-negative capacity already implies this binary carries the buffer parameter.
