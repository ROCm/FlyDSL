...
_coord_swizzle_type = globals().get("CoordSwizzleType", None)
if _coord_swizzle_type is not None:
    @ir.register_value_caster(_coord_swizzle_type.static_typeid, replace=True)
