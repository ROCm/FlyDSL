...
from ..._mlir.dialects.fly_rocdl import CopyOpCDNA4LdsReadTransposeType, MmaOpCDNA4_MFMAScaleType, MmaOpCDNA4_MFMAType
from ..._mlir.extras import types as T


def MFMA(m, n, k, elem_ty_a, elem_ty_b=None, elem_ty_acc=None):
    """Create a CDNA4 non-scale MFMA atom (k32 f16/bf16 on gfx950)."""
    ...
    return MmaOpCDNA4_MFMAType.get(m, n, k, ty_a, ty_b, ty_acc)
