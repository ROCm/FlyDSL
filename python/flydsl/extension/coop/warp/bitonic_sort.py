...
def warp_bitonic_sort(
    ...
    *,
    ...
    Raises:
        TypeError: If compare_op is not callable or key/payload item types are unsupported.
        ValueError: If width or a static valid_items count is invalid, an item sequence is
            empty, or payload shape differs from key shape.
    ...
    Examples:
        ...
        # ------------------+-------+-------+-------+-------++--------+--------+--------+------
        # keys in (striped) | [8,4] | [7,3] | [6,2] | [5,1] || [2,0]  | [-3,5] | [2,?] | [4,2]
