...
def warp_reduce_batched(
    ...
    *,
    ...
    Raises:
        TypeError: If value is not an item sequence, the operator is unsupported, or
            sync_physical_warp is not a Python bool.
        ValueError: If width or the scalar batch count is invalid.

    Examples:
        # All lanes of the physical warp participate. The tables show L0..L7 of that SAME warp.
        # width=4 forms independent groups: group 0 = L0..L3, group 1 = L4..L7.
        # For the remaining lanes, repeat the input pattern every eight lanes.
        # Numeric inputs use fx.Int32; [] denotes per-lane items.
        # ? denotes an unspecified output slot, not zero.
...
def warp_reduce_batched_to_blocked(
    ...
    *,
    ...
    Raises:
        TypeError: If value or op is unsupported, or sync_physical_warp is not a Python
            bool.
        ValueError: If width is not a supported power of two.
