...
class Pipeline:
    ...
    def add_pass(self, pass_name, **kwargs):
        kwargs = {k.replace("_", "-"): int(v) if isinstance(v, bool) else v for k, v in kwargs.items() if v is not None}
        if kwargs:
    ...
    def lower_to_llvm(self, use_bare_ptr_memref_call_conv=False):
        ...
        return (
            ...
            .convert_func_to_llvm(use_bare_ptr_memref_call_conv=use_bare_ptr_memref_call_conv)
    ...
    def buffer_results_to_out_params(self, add_result_attr: bool = None, hoist_static_allocs: bool = None):
    ...
    def convert_to_llvm(self, filter_dialects: List[str] = None, dynamic: bool = None):
        ...
        """
        self.add_pass("convert-to-llvm", filter_dialects=filter_dialects, dynamic=dynamic)
        return self
