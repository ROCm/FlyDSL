...
class FlyDSLDispatchCombineIntraNodeOp:
    ...
    # GEMM2+combine path on ``yanbo/fused_gemm2_combine`` meets the
    # contract (pre-populated ``shmem_comb_inp_tok``, caller-supplied
    # ``cur_tok``, upstream IPC ordering vs. the weight P2P).
