...
"""Layout-universal FP16/BF16 GEMM for gfx950."""
...
from kernels.common.run_cached import run_cached
from .gemm_a16w16_universe_gfx950_utils import (
    BlockSwizzle,
    GFX950_DMA_BYTES,
    GFX950_WAVE_SIZE,
...
def hgemm(
    ...
    assert param is not None, "unsupported gemm_a16w16_universe_gfx950 shape/config"
