...
def get_sw_ps_max_context_partition_num(
    ...
    if sliding_window <= 0:
        return 0
    return _cdiv(sliding_window, context_partition_size) + 1
...
def compile_pa_decode_sw(
    ...
    def pa_decode_sw_kernel(
        ...
        # Visible tiles are the sliding tail [context_len - sliding_window, context_len).
        context_len = buffer_ops.buffer_load(cl_rsrc, batch_idx, vec_width=1, dtype=T.i32)
        ...
        def _run_valid_partition():
            for _mtp_g in range_constexpr(_mtp_groups):
                ...
                if _mtp_subgroups == 1:
                    ...
                    seq_start = (
                        context_len - arith.constant(sliding_window, type=T.i32) + qi_val
                    )
                    ...
                    seq_start_0 = (
                        context_len - arith.constant(sliding_window, type=T.i32) + qi_val_0
                    )
                    seq_start_1 = (
                        context_len - arith.constant(sliding_window, type=T.i32) + qi_val_1
                    )
