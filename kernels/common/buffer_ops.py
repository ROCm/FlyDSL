...
def buffer_load(
    ...
    # Current ROCDL ODS models aux/cache policy as an i32 operand, not an
    # optional attribute.  Materialize zero too; passing None produces invalid IR.
    aux = _create_i32_constant(cache_modifier)

    # Emit buffer load
    load_op = rocdl.RawPtrBufferLoadOp(result_type, rsrc, offset, soffset, aux)
...
def buffer_store(
    ...
    *,
    ...
    # Emit buffer store
    rocdl.RawPtrBufferStoreOp(data, rsrc, offset, soffset, aux)
