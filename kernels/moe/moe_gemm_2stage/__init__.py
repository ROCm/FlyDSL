...
Layout-API package. Inputs are fp8 (E4M3) or int8 on CDNA3 (gfx94*) / CDNA4
(gfx95*); outputs f16/bf16/f32. int8 shares the fp8 pipeline (i32 MFMA acc,
f32 dequant). Stage2 accumulates via atomics or a separate topk-reduce kernel.
"""
