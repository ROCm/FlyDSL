...
bf16 A (no A-scale), bf16 ``[sorted_size, inter]`` intermediate. Reuses the standard
sorting/cumsum/m_indices contract and the shuffle_weight+e8m0_shuffle W layout. Launch
args are raw device pointers (``fx.Int64``); tensors passed as ``.data_ptr()``.
"""
