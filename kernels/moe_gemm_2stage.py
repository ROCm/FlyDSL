...
class _MoeGemm2ReduceWrapper:
    ...
    def __call__(
        ...
        intermediate = torch.empty(
            ...
            self._model_dim, device=arg_out.device,
...
def compile_moe_gemm2_ex(
    *,
    ...
    """Compile MoE GEMM2 kernel with optional mode.

    This function is retained for backwards compatibility.
    And can be extended with more experimental modes in the future (like last block reduce).
    ...
    return compile_moe_gemm2(
        ...
        out_dtype=out_dtype,
        use_cshuffle_epilog=use_cshuffle_epilog,
        reduce=(mode == MoeGemm2Mode.REDUCE),
    )
