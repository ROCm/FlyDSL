"""BM96/BN512 experiment for the fixed-shape FlyDSL mxfp4 MoE path."""
...
MXFP4_BLOCK_M = 96
MXFP4_STAGE1_KERNEL = "flydsl_experiment_mxfp4_moe_g1_a4w4_NE385_H7168_E512_BM96_BN512"
MXFP4_STAGE2_KERNEL = (
    "flydsl_experiment_mxfp4_moe_g2_a4w4_NE385_H7168_E512_BM96_NONATOMIC_MXFP4OUT"
)
...
def compile_kimi_mxfp4_gemm1_16384():
    ...
    This is a BM96/BN512 experiment based on the BM128 aiter-selected
    ...
    module_name = "flydsl_kimi_mxfp4_gemm1_NE385_H7168_E512_BM96_BN512_v3_knownblock"
    ...
    def gemm1(
        ...
        lds_acc = SmemPtr(base_ptr, lds_offset, T.f32, shape=(acc_segment_m * tile_n,)).get()
        ...
        def _then_body():
            ...
            for seg_m in range_constexpr(tile_m // acc_segment_m):
                ...
                for mi_seg in range_constexpr(acc_segment_m_repeat):
                    mi = seg_m_repeat_base + mi_seg
                ...
                for n_half in range_constexpr(tile_n // 256):
                    ...
                    for mr_pair in range_constexpr(2):
                        global_mr = seg_m_repeat_base + mr_pair
                        row_local = arith.constant(mr_pair * 16, index=True) + m_lane
                    ...
                    with ir.InsertionPoint(_if_scale.then_block):
                        ...
                        chunk = bx * arith.constant(tile_m // 32, index=True) + arith.constant(seg_m, index=True)
                        dword_off = (
...
def compile_kimi_mxfp4_gemm2_mxfp4out_16384():
    ...
    # Keep the BN512 accumulator tile in AGPRs.  BM96/BN512 has
    # (96/16)*(512/64/16)*4 = 192 f32 accumulator lanes.
    gemm2_agpr_value_attrs = {"passthrough": [["amdgpu-agpr-alloc", "192,192"]]}
    gemm2_agpr_llvm_options = {"amdgpu-mfma-vgpr-form": False}

    module_name = "flydsl_kimi_mxfp4_gemm2_mxfp4out_NE385_H7168_E512_BM96_BN512_v0_spillcheck"
...
def compile_kimi_mxfp4_sort_16384():
    ...
    @flyc.kernel(
        name="flydsl_kimi_mxfp4_sort_count_NE385_TOPK9_M16384_BM96_v0_spillcheck",
    ...
    @flyc.kernel(
        name="flydsl_kimi_mxfp4_sort_cumsum_NE385_TOPK9_M16384_BM96_v0_spillcheck",
        known_block_size=[threads, 1, 1],
    )
    def sort_cumsum(
    ...
    @flyc.kernel(
        name="flydsl_kimi_mxfp4_sort_place_pad_NE385_TOPK9_M16384_BM96_v0_spillcheck",
        known_block_size=[threads, 1, 1],
    )
    def sort_place_pad(
...
def compile_kimi_mxfp4_quant_16384():
    ...
    @flyc.kernel(
        name="flydsl_kimi_mxfp4_quant_NE385_TOPK9_H7168_M16384_BM96_v0_spillcheck",
        known_block_size=[threads, 1, 1],
    )
...
def compile_kimi_mxfp4_sort_scales_16384():
    ...
    @flyc.kernel(
        name="flydsl_kimi_mxfp4_sort_scales_NE385_H7168_E512_M16384_BM96_v0_spillcheck",
        known_block_size=[threads, 1, 1],
    )
    def sort_scales(
