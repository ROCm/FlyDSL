...
FLIR's design is inspired by and builds upon ideas from several projects:
...
- [NVIDIA CUTLASS](https://github.com/NVIDIA/cutlass) – CuTe layout algebra and tiled copy abstractions
