module attributes {gpu.container_module} {
  ...
  llvm.func @vectorAdd(%arg0: !llvm.ptr<1>, %arg1: !llvm.struct<packed (struct<packed (i32)>, struct<packed ()>)>, %arg2: !llvm.ptr<1>, %arg3: !llvm.ptr<1>, %arg4: i32, %arg5: !llvm.ptr) attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func <%arg5 : !llvm.ptr> @kernels::@vectorAddKernel_0 blocks in (%20, %5, %5) threads in (%6, %5, %5) : i64 args(%arg0 : !llvm.ptr<1>, %23 : !llvm.struct<packed (struct<packed (i32)>, struct<packed ()>)>, %arg2 : !llvm.ptr<1>, %arg3 : !llvm.ptr<1>)
    llvm.return
  }
}
