module attributes {gpu.container_module} {
  gpu.module @kernels [#rocdl.target<chip = "gfx942">] {
    gpu.func @vectorAddKernel_0(%arg0: !fly.memref<f32, global, ?:1,  align<4>>, %arg1: !fly.memref<f32, global, 128:1,  align<4>>, %arg2: !fly.memref<f32, global, 128:1,  align<4>>) kernel {
      ...
      %2 = fly.make_int_tuple() : () -> !fly.int_tuple<64>
      %3 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      ...
      %6 = fly.make_int_tuple() : () -> !fly.int_tuple<64>
      %7 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      ...
      %10 = fly.make_int_tuple() : () -> !fly.int_tuple<64>
      %11 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      ...
      %24 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      %25 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      ...
      %28 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      %29 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      ...
      %33 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      ...
      %37 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      %38 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      ...
      %42 = fly.make_int_tuple() : () -> !fly.int_tuple<1>
      ...
      %45 = fly.make_int_tuple(%1) : (i32) -> !fly.int_tuple<(*,?)>
      ...
      %52 = fly.make_int_tuple(%1) : (i32) -> !fly.int_tuple<(*,?)>
  ...
  func.func @vectorAdd(%arg0: !fly.memref<f32, global, ?:1,  align<4>>, %arg1: !fly.memref<f32, global, 128:1,  align<4>>, %arg2: !fly.memref<f32, global, 128:1,  align<4>>, %arg3: i32, %arg4: !gpu.async.token) attributes {llvm.emit_c_interface} {
    ...
    %2 = arith.floordivsi %1, %c64_i32 : i32
    %3 = arith.index_cast %2 : i32 to index
    gpu.launch_func <%arg4 : !gpu.async.token> @kernels::@vectorAddKernel_0 blocks in (%3, %c1, %c1) threads in (%c64, %c1, %c1)  args(%arg0 : !fly.memref<f32, global, ?:1,  align<4>>, %arg1 : !fly.memref<f32, global, 128:1,  align<4>>, %arg2 : !fly.memref<f32, global, 128:1,  align<4>>)
    return
  }
}
